...
/**
 * Vista interna para editar usuarios del sistema.
 * Permite modificar datos personales, credenciales, rol, fecha de nacimiento, correo y teléfono de un usuario.
...
public class UsuarioEditarView extends JInternalFrame {
    ...
    /**
     * Constructor de UsuarioEditarView.
    ...
    /**
     * Obtiene el botón para actualizar usuario.
     * @return JButton para actualizar usuario.
     */
    public JButton getBtnActualizar() {
        return btnActualizar;
    }
    /**
     * Establece el botón para actualizar usuario.
     * @param btnActualizar JButton para actualizar usuario.
     */
